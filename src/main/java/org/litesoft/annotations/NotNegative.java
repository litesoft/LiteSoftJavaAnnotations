...
public @interface NotNegative {
  ...
  class ConstrainTo {
    public static int valueOrZero( int pToCheck ) {
      return (ZERO_int <= pToCheck) ? pToCheck : ZERO_int;
    }

    public static long valueOrZero( long pToCheck ) {
      return (ZERO_long <= pToCheck) ? pToCheck : ZERO_long;
    }

    public static float valueOrZero( float pToCheck ) {
      return (ZERO_float <= pToCheck) ? pToCheck : ZERO_float;
    }

    public static double valueOrZero( double pToCheck ) {
      return (ZERO_double <= pToCheck) ? pToCheck : ZERO_double;
    }
  }
